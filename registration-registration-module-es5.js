...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["registration-registration-module"], {
  ...
  function srcAppRegistrationConsumerConsumerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ConsumerComponent_ng_template_165_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ConsumerComponent_ng_template_165_Template_button_click_0_listener() {
          var d_r48 = ctx.dismiss;
          return d_r48("Cross click");
        });
    ...
    ConsumerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 169,
      vars: 92,
      consts: [[1, "page_banner"], [1, "container"], [1, "row"], [1, "col-md-6"], [1, "form-group", "row", "flexAlign"], [1, "col-4"], ["name", "sel2", 1, "form-control", "form-custom", 3, "ngModel", "ngModelChange"], ["value", "en"], ["value", "ma"], ["value", "ch"], [1, "con-form"], [3, "formGroup"], [1, "form-group"], [1, "text-danger"], ["type", "text", "formControlName", "name", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], [1, "form-row"], [1, "form-group", "col-md-4", "col-sm-12"], ["type", "text", "formControlName", "NRIC_no", 1, "form-control", 3, "ngClass"], ["formControlName", "marital_status", 1, "form-control", 3, "ngClass"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "gender", 1, "form-control", 3, "ngClass"], [1, "form-group", "col-md-6", "col-sm-12"], ["formControlName", "status", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "race", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "country", 1, "form-control"], ["type", "text", "formControlName", "passport_no", 1, "form-control"], ["type", "text", "formControlName", "address", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "town", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "state", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "postal_code", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "whatsapp", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "mobile", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "email", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "type_of_buusiness", 1, "form-control"], ["formControlName", "preffered_communication", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "profession", 1, "form-control", 3, "ngClass"], ["type", "text", "formControlName", "income_net", 1, "form-control", 3, "ngClass"], [1, "form-check"], ["formControlName", "spices", "type", "checkbox", "value", "", 1, "form-check-input"], [1, "form-check-label"], [1, "teamsread", 3, "click"], [1, "text-center"], [1, "btn", "btn-primary", "mr-1", "btn-custom", 3, "disabled", "click"], [1, "btn", "btn-secondary", 3, "click"], ["content", ""], ["confirmation", ""], [1, "invalid-feedback"], [4, "ngIf"], [3, "value"], ["type", "button", "aria-label", "Close", 1, "close", 3, "click"], ["aria-hidden", "true"], [1, "modal-header"], [1, "modal-body"], [3, "innerHTML"], [1, "modal-footer"], [1, "btn", "btn-primary", "btn-custom", 3, "click"]],
  ...
  function srcAppRegistrationRegisterViewRegisterViewComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RegisterViewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 22,
      vars: 0,
      consts: [[1, "page_banner"], [1, "container"], [1, "registration"], [1, "row", "our_concept"], [1, "col-md-6", "col-xs-12", "mb-4"], [1, "card"], [1, "card-body"], [1, "btn", "btn-primary", "btn-custom", 3, "click"]],
